...
public class FragmentColor extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sharedPreferences = getActivity().getSharedPreferences(AppDataMap.APP_PREFERENCES, Context.MODE_PRIVATE);
        boolean isSwiched = sharedPreferences.getBoolean(AppDataMap.NAV_THEME_DARK, false);
        if (isSwiched)
    ...
    public void onClick(View view) {
        ...
        if (themeSwitch.isChecked()) {
            ...
            ed.putBoolean(AppDataMap.NAV_THEME_DARK, true);
            ...
            ed.putBoolean(AppDataMap.NAV_THEME_DARK, false);
        }
